...
<template>
  ...
  >
    <div
      class="-mt-px flex min-h-full flex-col overflow-hidden border-r border-r-alice-blue bg-white transition-all duration-200 dark:border-r-outer-space dark:bg-charcoal"
    ...
    >
      ...
      >
        ...
        <span class="font-semibold text-battleship-grey group-hover:text-purple-heart"
          >Hide Sidebar</span
        >
      </button>
    </div>
    <button
      ...
      @click="showSlide"
    >
      <img class="-ml-2" src="/assets/icons/icon-show-sidebar.svg" alt="show sidebar" />
    </button>
  </div>
</template>
